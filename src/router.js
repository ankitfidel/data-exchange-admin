      ...
      },
        {
            ...
            childRoutes: [
                ...
                },
                {
                    ...
                    getComponent(nextState, cb) {
                        require.ensure([], require => {
                            cb(null, require('./routes/viewcompanies'))
                        })
                    }
                },
                {
                    ...
                    getComponent(nextState, cb) {
                        require.ensure([], require => {
                            cb(null, require('./routes/viewaddress'))
                        })
                    }
                },

                {
                    ...
                    getComponent(nextState, cb) {
                        require.ensure([], require => {
                            cb(null, require('./routes/viewusers'))
                        })
                    }
                },

                {
                    ...
                    getComponent(nextState, cb) {
                        require.ensure([], require => {
                            cb(null, require('./routes/addcompany'))
                        })
                    }
                },
                {
                    ...
                    getComponent(nextState, cb) {
                        require.ensure([], require => {
                            cb(null, require('./routes/addaddress'))
                        })
                    }
                },
                {
                    ...
                    getComponent(nextState, cb) {
                        require.ensure([], require => {
                            cb(null, require('./routes/adduseraddress'))
                        })
                    }
                },
                {
                    ...
                    getComponent(nextState, cb) {
                        require.ensure([], require => {
                            cb(null, require('./routes/viewuseraddress'))
                        })
                    }
                },
                ...
                },
                {
                    ...
                    getComponent(nextState, cb) {
                        require.ensure([], require => {
                            cb(null, require('./routes/useraddress'))
                        })
                    }
                },

                {
                    ...
                    getComponent(nextState, cb) {
                        require.ensure([], require => {
                            cb(null, require('./routes/adduser'))
                        })
                    }
                },
